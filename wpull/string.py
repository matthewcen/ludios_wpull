...
def detect_encoding(data, encoding=None, fallback: str ='latin1', is_html: bool = False) -> str:
    ...
    for candidate in candidates:
        ...
        candidate: str = normalize_codec_name(candidate)
...
def format_size(num: int, format_str: str = '{num:.1f} {unit}') -> str:
